...
public class IconOutlineUtils {

    public IconOutlineUtils() {}

    private static final Icon ic_default = new Icon(0, R.drawable.ic_category_fill0_300_48, "Category");

    private static final Icon ic_cash = new Icon(1, R.drawable.ic_cash_fill0_300_48, "Cash");
    private static final Icon ic_wallet = new Icon(2, R.drawable.ic_account_balance_wallet_fill0_300_48, "Wallet");
    private static final Icon ic_credit_card = new Icon(3, R.drawable.ic_credit_card_fill0_300_48, "Credit Card");
    private static final Icon ic_savings = new Icon(4, R.drawable.ic_savings_fill0_300_48, "Savings");
    private static final Icon ic_trending_up = new Icon(5, R.drawable.ic_trending_up_fill0_300_48, "Trending up");

    private static final Icon ic_home = new Icon(6, R.drawable.ic_house_fill0_300_48, "Home");
    ...
    private static final Icon ic_shopping_cart = new Icon(9, R.drawable.ic_shopping_fill0_300_48, "Shopping Cart");
    private static final Icon ic_pharmacy = new Icon(10, R.drawable.ic_local_pharmacy_fill0_300_48, "Pharmacy");

    private static final Icon ic_work = new Icon(11, R.drawable.ic_business_center_fill0_300_48, "Work");
    private static final Icon ic_gavel = new Icon(12, R.drawable.ic_gavel_fill0_300_48, "Gavel");
    private static final Icon ic_bank = new Icon(13, R.drawable.ic_account_balance_fill0_300_48, "Bank");
    private static final Icon ic_library = new Icon(14, R.drawable.ic_local_library_fill0_300_48, "Library");
    private static final Icon ic_school = new Icon(15, R.drawable.ic_school_fill0_300_48, "School");

    private static final Icon ic_devices = new Icon(16, R.drawable.ic_devices_fill0_300_48, "Devices");
    private static final Icon ic_checkroom = new Icon(17, R.drawable.ic_checkroom_fill0_300_48, "Checkroom");
    private static final Icon ic_shopping_bag = new Icon(18, R.drawable.ic_shopping_bag_fill0_300_48, "Shopping bag");
    private static final Icon ic_heart = new Icon(19, R.drawable.ic_favorite_fill0_300_48, "Heart");
    private static final Icon ic_celebration = new Icon(20, R.drawable.ic_celebration_fill0_300_48, "Celebration");

    private static final Icon ic_pet = new Icon(21, R.drawable.ic_pets_fill, "Pet");
    private static final Icon ic_child = new Icon(22, R.drawable.ic_child_care_fill0_300_48, "Child");
    private static final Icon ic_toy = new Icon(23, R.drawable.ic_toys_fill0_300_48, "Toy");
    private static final Icon ic_videogame = new Icon(24, R.drawable.ic_stadia_controller_fill0_300_48, "Videogame");
    private static final Icon ic_attractions = new Icon(25, R.drawable.ic_attractions_fill0_300_48, "Attractions");

    private static final Icon ic_car = new Icon(26, R.drawable.ic_directions_car_fill0_300_48, "Car");
    private static final Icon ic_motor_sports = new Icon(27, R.drawable.ic_sports_motorsports_fill0_300_48, "Motor bike");
    private static final Icon ic_pedal_bike = new Icon(28, R.drawable.ic_pedal_bike_fill0_300_48, "Pedal bike");
    private static final Icon ic_commute = new Icon(29, R.drawable.ic_commute_fill0_300_48, "Commute");
    private static final Icon ic_gas_station = new Icon(30, R.drawable.ic_local_gas_station_fill0_300_48, "Gas station");
    ...
    private static final Icon ic_dentistry = new Icon(33, R.drawable.ic_dentistry_fill0_300_48, "Dentistry");
    private static final Icon ic_ecg_heart = new Icon(34, R.drawable.ic_ecg_heart_fill0_300_48, "Ecg heart");
    ...
    private static final Icon ic_bakery = new Icon(37, R.drawable.ic_bakery_dining_fill0_300_48, "Bakery");
    private static final Icon ic_takeout = new Icon(38, R.drawable.ic_takeout_dining_fill0_300_48, "Takeout");
    private static final Icon ic_fruit = new Icon(39, R.drawable.ic_nutrition_fill0_300_48, "Fruit");
    private static final Icon ic_pizza = new Icon(40, R.drawable.ic_local_pizza_fill0_300_48, "Pizza");

    private static final Icon ic_hamburger = new Icon(41, R.drawable.ic_lunch_dining_fill0_300_48, "Hamburger");
    private static final Icon ic_beer = new Icon(42, R.drawable.ic_sports_bar_fill0_300_48, "Beer");
    private static final Icon ic_sports = new Icon(43, R.drawable.ic_sports_fill0_300_48, "Sports");
    private static final Icon ic_local_activity = new Icon(44, R.drawable.ic_local_activity_fill0_300_48, "Local activity");
    private static final Icon ic_wine = new Icon(45, R.drawable.ic_wine_bar_fill0_300_48, "Wine");

    private static final Icon ic_nightlife = new Icon(46, R.drawable.ic_nightlife_fill0_300_48, "Nightlife");
    private static final Icon ic_theaters = new Icon(47, R.drawable.ic_theaters_fill0_300_48, "Theaters");
    private static final Icon ic_music = new Icon(48, R.drawable.ic_music_note_fill0_300_48, "Music");
    private static final Icon ic_casino = new Icon(49, R.drawable.ic_casino_fill0_300_48, "Casino");
    ...
    private static final Icon ic_luggage = new Icon(52, R.drawable.ic_luggage_fill0_300_48, "Luggage");
    private static final Icon ic_map = new Icon(53, R.drawable.ic_map_fill0_300_48, "Map");
    private static final Icon ic_camera = new Icon(54, R.drawable.ic_photo_camera_fill0_300_48, "Camera");
    private static final Icon ic_spa = new Icon(55, R.drawable.ic_spa_fill0_300_48, "Spa");

    private static final Icon ic_florist = new Icon(56, R.drawable.ic_local_florist_fill0_300_48, "Florist");
    private static final Icon ic_grass = new Icon(57, R.drawable.ic_grass_fill, "Grass");
    private static final Icon ic_plant = new Icon(58, R.drawable.ic_potted_plant_fill0_300_48, "Potted plant");
    private static final Icon ic_grill = new Icon(59, R.drawable.ic_outdoor_grill_fill0_300_48, "Outdoor grill");
    private static final Icon ic_pool = new Icon(60, R.drawable.ic_pool_fill0_300_48, "Swimming pool");

    private static final Icon ic_beach = new Icon(61, R.drawable.ic_beach_access_fill0_300_48, "Beach");
    private static final Icon ic_park= new Icon(62, R.drawable.ic_park_fill0_300_48, "Park");
    private static final Icon ic_cabin = new Icon(63, R.drawable.ic_cabin_fill0_300_48, "Cabin");
    private static final Icon ic_camping = new Icon(64, R.drawable.ic_camping_fill0_300_48, "Camping");
